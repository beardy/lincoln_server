...
// ~~ The result is a thin server and heavier client, but due to our choice of web-based interface, both seem lightweight.
//
...
// Jim Vallandingham
//
// lincoln_server - sniffer & database writer
// main.cpp ~ This file does the sniffing itself.
//
...
// ~~ Globals:
//
// TODO: Tidy this file up. Create proper sniffer classes and whatnot.
...
// Structs taken from example programs. Useful for analyzing sniffed packets.
...
void got_packet(u_char *args, const struct pcap_pkthdr *header, const u_char *packet)
{
	...
	// determine protocol, if it's not TCP, then our filter expression failed. Discard packet.
	switch(ip->ip_p)
	{
		case IPPROTO_TCP:
			printf("   Protocol: TCP\n");
    ...
    // Need to determine if it's incoming or not.
